...
const Carousal = () => {
  const { isLoadingTopRatingProducts, topRatedProducts, isTopRatingProductsError } = useSelector(
    (state) => state.product
  );
  ...
  return (
    <SpinContainer
      spinStyle="size"
      spinning={isLoadingTopRatingProducts}
      isError={isTopRatingProductsError}
      value={true}
      data={topRatedProducts}
    >
      {!isTopRatingProductsError && (
